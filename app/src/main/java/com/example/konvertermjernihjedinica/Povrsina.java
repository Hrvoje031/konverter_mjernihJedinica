...
public class Povrsina extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] arraySpinnerFrom = new String[] {"Odaberi jedinicu", "Hektar(ha)", "Kvadratni kilometar", "Kvadratni metar", "Kvadratni centimetar"};
        ArrayAdapter<String> lengthTemp = new ArrayAdapter<>(this, R.layout.spinnerpovrsina, arraySpinnerFrom);
        lengthTemp.setDropDownViewResource(R.layout.spinnerpovrsina_drop);
        spinnerFrom.setAdapter(lengthTemp);


        spinnerTo = findViewById(R.id.spinner_U);
        String [] arraySpinnerTo = new String[] {"Odaberi jedinicu", "Hektar(ha)", "Kvadratni kilometar", "Kvadratni metar", "Kvadratni centimetar"};
        ArrayAdapter<String> lengthTo = new ArrayAdapter<>(this,  R.layout.spinnerpovrsina, arraySpinnerFrom);
        lengthTemp.setDropDownViewResource(R.layout.spinnerpovrsina_drop);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Povrsina.this, MainActivity.class);
                startActivity(i);
            }
        });
            ...
            case 1:
                if (to == 2) {
                    if (enterValue.getText().toString().equals("")) {
                        ...
                        resultView.setText(strDouble + " kva.km.");
                    }
                } else if (to == 3) {
                    if (enterValue.getText().toString().equals("")) {
                        resultView.setText("0");
                        ...
                        resultView.setText(strDouble + " kva.m");
                    }
                } else if (to == 4) {
                    if (enterValue.getText().toString().equals("")) {
                        resultView.setText("0");
                        ...
                        String strDouble = String.format("%.2f", result);
                        resultView.setText(strDouble + " kva.cm.");
                    }
                }
                break;
            case 2:
                if (to == 1) {
                    if (enterValue.getText().toString().equals("")) {
                        ...
                        result = value * 100;
                        String strDouble = String.format("%.2f", result);
                        resultView.setText(strDouble + " ha.");
                    }
                } else if (to == 3) {
                    if (enterValue.getText().toString().equals("")) {
                        resultView.setText("0");
                    ...
                    if (enterValue.getText().toString().equals("")) {
                        ...
                        double value = Double.parseDouble(enterValue.getText().toString());
                        result = (float) (value * 10000000000f);
                        String strDouble = String.format("%.2f", result);
